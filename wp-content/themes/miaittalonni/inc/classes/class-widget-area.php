...
if ( ! class_exists( 'Miaittalonni_Widget_Area' ) ) {

	class Miaittalonni_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'miaittalonni_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'miaittalonni_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'miaittalonni_widget_area_classes', $classes, $area_id );
	...
	function miaittalonni_widget_area() {
		return Miaittalonni_Widget_Area::get_instance();
	}

	miaittalonni_widget_area();
}
