...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'posts-list__item card' ); ?>>
	...
	<div class="post-list__item-content">
		...
		<figure class="post-thumbnail">
			<?php $size = miaittalonni_post_thumbnail_size( array( 'class_prefix' => 'post-thumbnail--' ) ); ?>
		...
		<div class="entry-content">
			<?php
				...
				if ( false === $embed_content ) {
					...
					$blog_content = get_theme_mod( 'blog_posts_content', miaittalonni_theme()->customizer->get_default( 'blog_posts_content' ) );
